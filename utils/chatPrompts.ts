...
/** Detect the first normal chat turn after leaving an interactive mode. */
...
`;
        ...
        // 特殊模式结束后的第一轮必须把输出格式重新锚定到 ChatApp。主聊天路径从
        // 完整 DB 历史计算，直接调用 ChatPrompts 的旧路径则用 currentMsgs 兜底。
