...
-- 完整 SQL 请点"复制"按钮获取`}</pre>
                ...
                {char && (<details style={{ marginTop: 12 }}>
                    <summary style={{ minHeight: 44, fontSize: 13, color: F.textPrimary, cursor: 'pointer', userSelect: 'none' }}>
                        私聊交流步伐
                    </summary>
                    <div style={{ marginTop: 8, background: F.surface, boxShadow: S.raisedSoft, borderRadius: R.smallCard, padding: 14, border: `1px solid ${F.borderSoft}` }}>
                        <div style={{ fontSize: 11, color: F.textSecondary, lineHeight: 1.65, marginBottom: 12 }}>
                            ...
                            return (
                                <div key={key} style={{ marginBottom: key === 'emoji' ? 0 : 10 }}>
                                    <label className={labelClass} style={{ display: 'flex', justifyContent: 'space-between' }}>
                                        <span>{label}</span>
                                        <span style={{ color: F.textPrimary }}>{Math.round(value * 100)}%</span>
                                    </label>
                                    <input
                                        type="range"
                                        min="0"
                                        ...
                                        style={{ width: '100%', height: 44, accentColor: F.textPrimary }}
                                    />
                                </div>
                            );
                        })}
                        <button
                            ...
                            style={{
                                width: '100%', marginTop: 12, minHeight: 44, padding: '8px 0', borderRadius: R.button, boxShadow: S.raisedSoft,
                                border: `1px solid ${F.borderSoft}`, background: F.surface,
                                fontSize: 11, fontWeight: 700, color: F.textPrimary, cursor: 'pointer',
                            }}
                        >
                            恢复温和默认值
                        </button>
                        <div style={{ fontSize: 10, color: F.textPrimary, lineHeight: 1.55, marginTop: 10 }}>
                ...
                {!isGlobal && char && <div style={{ marginTop: 16 }}>
                    <button type="button" onClick={() => setShowHistoryCleanup(true)} style={{ minHeight: 44, background: F.surface, color: F.textPrimary, borderRadius: R.button, boxShadow: S.raisedSoft }} className="w-full rounded-2xl border border-red-100 bg-red-50 py-3 text-sm font-bold text-red-700">清理指定范围 / 保留最近 N 条</button>
                                            ...
                                            <div style={{
                                                ...
                                                <button
                                                    ...
                                                    style={{
                                                        ...
                                                        minHeight: 44, boxShadow: S.raisedSoft,
