...
export default function AppearanceEmergency() {
    ...
    return <section className="space-y-4 p-5" style={{ background: F.surface, border: `1px solid ${F.borderSoft}`, color: F.textPrimary, borderRadius: R.bigCard, boxShadow: S.raisedSoft }}>
